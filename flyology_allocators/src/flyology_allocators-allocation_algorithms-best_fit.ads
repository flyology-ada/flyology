...
package Flyology_Allocators.Allocation_Algorithms.Best_Fit is new
  Flyology_Allocators.Allocation_Algorithms.Contract
    (Algorithm_Minimum_Block_Limit         => Best_Fit_Kernel.Minimum_Block_Limit,
     ...
     Implementation_Usable_Capacity        => Best_Fit_Kernel.Configuration_Usable_Capacity,
     Implementation_Minimum_Block_Size     => Best_Fit_Kernel.Configuration_Minimum_Block_Size,
     Implementation_Required_Storage       => Best_Fit_Kernel.Required_Storage,
     Implementation_Initialize             => Best_Fit_Kernel.Initialize,
     Implementation_Create_Or_Attach       => Best_Fit_Kernel.Create_Or_Attach,
     ...
     Implementation_Current_Metadata       => Best_Fit_Kernel.Current_Metadata,
     Implementation_Is_Poisoned            => Best_Fit_Kernel.Is_Poisoned,
     Implementation_Poison                 => Best_Fit_Kernel.Poison,
     Implementation_Try_Allocate_Immediate => Best_Fit_Kernel.Try_Allocate,
     ...
     Implementation_Attach_Allocation      => Best_Fit_Kernel.Attach_Allocation,
