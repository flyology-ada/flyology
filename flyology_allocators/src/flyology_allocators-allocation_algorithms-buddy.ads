...
--  tree splits power-of-two blocks and coalesces free siblings lazily when a
--  later allocation cannot find a large enough retained block. One persisted
  ...
  Flyology_Allocators.Allocation_Algorithms.Contract
    (Algorithm_Minimum_Block_Limit =>
     ...
     Implementation_Usable_Capacity =>
       Buddy_Kernel.Configuration_Usable_Capacity,
     Implementation_Minimum_Block_Size =>
       Buddy_Kernel.Configuration_Minimum_Block_Size,
