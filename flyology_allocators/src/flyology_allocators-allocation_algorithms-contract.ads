...
--  dispatch, stored callback, or stored native pointer to backing bytes.
...
--  @formal Algorithm_View Local attached implementation view
...
--  @formal Implementation_Detach Detach one local view
--  @formal Implementation_Is_Attached Test local attachment
