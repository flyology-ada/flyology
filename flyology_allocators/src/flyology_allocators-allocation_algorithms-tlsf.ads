with Flyology_Allocators.Allocation_Algorithms.TLSF_Kernel;
...
package Flyology_Allocators.Allocation_Algorithms.TLSF is new
  Flyology_Allocators.Allocation_Algorithms.Contract
    (Algorithm_Minimum_Block_Limit         => TLSF_Kernel.Minimum_Block_Limit,
     ...
     Implementation_Usable_Capacity        => TLSF_Kernel.Configuration_Usable_Capacity,
     Implementation_Minimum_Block_Size     => TLSF_Kernel.Configuration_Minimum_Block_Size,
     Implementation_Required_Storage       => TLSF_Kernel.Required_Storage,
     Implementation_Initialize             => TLSF_Kernel.Initialize,
     Implementation_Create_Or_Attach       => TLSF_Kernel.Create_Or_Attach,
     ...
     Implementation_Current_Metadata       => TLSF_Kernel.Current_Metadata,
     Implementation_Is_Poisoned            => TLSF_Kernel.Is_Poisoned,
     Implementation_Poison                 => TLSF_Kernel.Poison,
     Implementation_Try_Allocate_Immediate => TLSF_Kernel.Try_Allocate,
     ...
     Implementation_Attach_Allocation      => TLSF_Kernel.Attach_Allocation,
