...
package Flyology_Allocators.Allocation_Algorithms.Slab_Span is new
  Flyology_Allocators.Allocation_Algorithms.Contract
    (Algorithm_Minimum_Block_Limit         => Slab_Span_Kernel.Minimum_Block_Limit,
     ...
     Implementation_Usable_Capacity        => Slab_Span_Kernel.Configuration_Usable_Capacity,
     Implementation_Minimum_Block_Size     => Slab_Span_Kernel.Configuration_Minimum_Block_Size,
