 ...
 * not provide the usable binding. This fixed-width C leaf retains the
 * workaround through GNAT 14, keeps the memory order compile-time constant,
 * and contains no retry or policy.
 *
