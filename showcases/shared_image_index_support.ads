...
package Shared_Image_Index_Support is
   ...
   package Job_Representation is new DS.Storage_Types.Immutable
     (Byte_Size          => 16,
   ...
   function Observe_Job
     (Item : Job_Representation.Const_Ref) return Image_Job;
   procedure Construct_Job
     (Item : in out Job_Representation.Builder; Data : Image_Job);

   package Job_Elements is new DS.Storage_Types.Elements
   ...
   package Result_Representation is new DS.Storage_Types.Immutable
     (Byte_Size          => 72,
      Required_Alignment => 8,
   ...
   function Observe_Result
     (Item : Result_Representation.Const_Ref) return Image_Result;
   procedure Construct_Result
     (Item : in out Result_Representation.Builder; Data : Image_Result);

   package Result_Elements is new DS.Storage_Types.Elements
   ...
   package Image_Maps is new DS.Hash_Maps
     (Key     => U64_Elements.Element,
      Element => Result_Elements);
