...
private package Flyology_Bench.Internal_Condition_Test_Hooks is
   ...
   with Import, External_Name => "flyology_bench_disabled_condition_hook_must_be_elided_pause_enabled";

   function Pause_Clock_Now return Interfaces.Unsigned_64
   with Import, External_Name => "flyology_bench_disabled_condition_hook_must_be_elided_pause_clock";

   procedure Advance_Pause_Clock (Nanoseconds : Interfaces.Unsigned_64)
   with Import, External_Name => "flyology_bench_disabled_condition_hook_must_be_elided_pause_advance";
