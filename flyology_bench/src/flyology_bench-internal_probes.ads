...
private package Flyology_Bench.Internal_Probes is
   ...
   procedure Read_Clock (Nanoseconds : out Interfaces.Unsigned_64; Available : out Boolean);

   procedure Read_Clock_Resolution (Nanoseconds : out Interfaces.Unsigned_64; Available : out Boolean);

   function Native_Thread_Id return Interfaces.Unsigned_64;

   type Placement_Outcome is (Advisory_Placement, Strict_Placement, Placement_Refused);
   ...
   type Host_CPU_Counters is array (Natural range 0 .. Maximum_Host_CPUs - 1) of Interfaces.Unsigned_64;
