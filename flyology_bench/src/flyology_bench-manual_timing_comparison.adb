...
package body Flyology_Bench.Manual_Timing_Comparison is
   ...
   begin
      ...
      Result.Reference_Data.Custom_Data.Data.Descriptors
        (Timer_Axis).Resolution_Value :=
          Source_Resolution
          / Long_Float (Iterations_Per_Sample (Result.Reference_Data));
      Result.Contender_Data.Custom_Data.Data.Descriptors
        (Timer_Axis).Resolution_Value :=
          Source_Resolution
          / Long_Float (Iterations_Per_Sample (Result.Contender_Data));
   end Compare;
