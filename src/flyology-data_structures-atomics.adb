...
package body Flyology.Data_Structures.Atomics is
   ...
   function Supported return Boolean is
     (AP.Atomic_Always_Lock_Free (4)
      and then AP.Atomic_Always_Lock_Free (8));

   function Load_Acquire_U32
     (Address : System.Address) return Interfaces.Unsigned_32 is
     (Interfaces.Unsigned_32 (AP.Atomic_Load_32 (Address, AP.Acquire)));

   function Load_Acquire_U64
     (Address : System.Address) return Interfaces.Unsigned_64 is
     (Interfaces.Unsigned_64 (AP.Atomic_Load_64 (Address, AP.Acquire)));

   function Load_Relaxed_U64
     (Address : System.Address) return Interfaces.Unsigned_64 is
     (Interfaces.Unsigned_64 (AP.Atomic_Load_64 (Address, AP.Relaxed)));
   ...
   is
      ...
      Result : Boolean;
   begin
      Result := AP.Atomic_Compare_Exchange_64
        (Address, Local'Address, AP.uint64 (Desired),
         Weak          => True,
