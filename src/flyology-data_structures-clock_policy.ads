...
is
   ...
   Clock_Failure             : constant Interfaces.Unsigned_64 := Interfaces.Unsigned_64'Last;
   ...
   function To_Nanoseconds
     (Status : C.int; Seconds : C.long; Nanoseconds : C.long) return Interfaces.Unsigned_64
   with
     Global => null,
     Post   =>
       ...
       = (if Status /= 0
            ...
            or else Interfaces.Unsigned_64 (Seconds) > Maximum_Clock_Seconds
            or else (Interfaces.Unsigned_64 (Seconds) = Maximum_Clock_Seconds
                     and then Interfaces.Unsigned_64 (Nanoseconds) > Maximum_Final_Nanoseconds)
          then Clock_Failure
          else
            Interfaces.Unsigned_64 (Seconds) * Nanoseconds_Per_Second + Interfaces.Unsigned_64 (Nanoseconds));
