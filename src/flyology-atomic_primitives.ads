...
private package Flyology.Atomic_Primitives with Preelaborate is
   ...
   pragma Inline_Always
     (Load_Acquire_U32, Load_Acquire_U64, Store_Release_U32,
      Store_Release_U64, Compare_Exchange_U32);
