...
is
   ...
   function Command_Allowed
     (Phase   : Public.Upgrade_Phase;
      Command : Public.Upgrade_Command) return Boolean
   is
     (case Phase is
         when Public.Stable =>
           Command = Public.Start_Upgrade,
         when Public.Starting =>
           Command in Public.Candidate_Started | Public.Cancel_Upgrade |
             Public.Record_Failure,
         when Public.Provisioning =>
           Command in Public.Candidate_Prepared | Public.Cancel_Upgrade |
             Public.Record_Failure,
         when Public.Prepared =>
           Command in Public.Start_Canary | Public.Cancel_Upgrade |
             Public.Promote_Upgrade | Public.Record_Failure,
         when Public.Canary =>
           Command in Public.Cancel_Upgrade | Public.Promote_Upgrade |
             Public.Record_Failure,
         ...
         when Public.Promoting =>
           Command in Public.Previous_Drain_Started |
             Public.Require_Rollback,
         ...
         when Public.Cancelled | Public.Completed | Public.Failed |
              Public.Rollback_Required =>
           False);

   function Phase_After
     (Phase   : Public.Upgrade_Phase;
      Command : Public.Upgrade_Command) return Public.Upgrade_Phase
   is
     (case Command is
         ...
         when Public.Cancel_Upgrade =>
           (if Phase = Public.Canary then Public.Revoking_Admission
            else Public.Cancelling),
   ...
   function Terminal (Phase : Public.Upgrade_Phase) return Boolean is
     (Phase in Public.Cancelled | Public.Completed | Public.Failed |
        Public.Rollback_Required);

   function Cancellation_Allowed
     (Phase : Public.Upgrade_Phase) return Boolean
   is
     (Phase in Public.Starting | Public.Provisioning | Public.Prepared |
        Public.Canary);

   function Promotion_Committed
     (Phase : Public.Upgrade_Phase) return Boolean
   is
     (Phase in Public.Promoting | Public.Draining_Previous |
        Public.Committing | Public.Completed | Public.Rollback_Required);

   function Authority_Matches
     (Expected, Supplied : Public.Upgrade_Handle) return Boolean
   is
     (Expected = Supplied);
