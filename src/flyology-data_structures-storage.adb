...
package body Flyology.Data_Structures.Storage is
   ...
   package U8_Access is new System.Address_To_Access_Conversions (Interfaces.Unsigned_8);
   package U32_Access is new System.Address_To_Access_Conversions (Interfaces.Unsigned_32);
   package U64_Access is new System.Address_To_Access_Conversions (Interfaces.Unsigned_64);
   package Eight_Access is new System.Address_To_Access_Conversions (Eight_Bytes);
   ...
   is (U8_Access.To_Pointer (Address).all);

   function Read_U32 (Address : System.Address) return Interfaces.Unsigned_32
   is (U32_Access.To_Pointer (Address).all);

   function Read_U64 (Address : System.Address) return Interfaces.Unsigned_64
   is (U64_Access.To_Pointer (Address).all);

   procedure Write_U8 (Address : System.Address; Value : Interfaces.Unsigned_8) is
   begin
   ...
   begin
      if Length = 8 then
         Eight_Access.To_Pointer (Target).all := Eight_Access.To_Pointer (Source).all;
         return;
      end if;
      declare
