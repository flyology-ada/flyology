package body Flyology.Dynamic_Destroy_Test_Hooks is
   ...
   private
      ...
      Retired_Release_Contention_Armed : Boolean := False;
   end State;
   ...
   protected body State is
      ...
      begin
         ...
         Retired_Release_Contention_Armed := False;
      end Reset;
      ...
      begin
         Retired_Release_Contention_Armed := True;
      end Arm_Retired_Release_Contention;

      procedure Consume_Retired_Release_Contention (Armed : out Boolean) is
      begin
         Armed := Retired_Release_Contention_Armed;
         Retired_Release_Contention_Armed := False;
      end Consume_Retired_Release_Contention;
   end State;
   ...
   procedure Arm_Retired_Release_Contention is
   begin
      State.Arm_Retired_Release_Contention;
   end Arm_Retired_Release_Contention;

   procedure Consume_Retired_Release_Contention (Armed : out Boolean) is
   begin
      State.Consume_Retired_Release_Contention (Armed);
   end Consume_Retired_Release_Contention;
