...
package Flyology.IO.Sockets.GNAT_Adapters is
   ...
   procedure Adopt (Source : in out GNAT.Sockets.Socket_Type; Target : in out Flyology.IO.Sockets.Socket_Type)
   with
     Pre  => GNAT.Sockets.To_C (Source) >= 0 and then not Flyology.IO.Sockets.Is_Open (Target),
     Post => GNAT.Sockets.To_C (Source) < 0 and then Flyology.IO.Sockets.Is_Open (Target);
   ...
   procedure Release (Source : in out Flyology.IO.Sockets.Socket_Type; Target : out GNAT.Sockets.Socket_Type)
