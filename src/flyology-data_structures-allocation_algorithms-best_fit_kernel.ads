...
--  fields. Allocation and reclamation are serialized across mappings by one
...
--  recovery.
--  @exclude
package Flyology.Data_Structures.Allocation_Algorithms.Best_Fit_Kernel
  with Preelaborate is

   --  Eight-byte magic stored in every arena header.
   Magic : constant Interfaces.Unsigned_64 := 16#4644_5342_4654_3031#;

   --  Schema identifier for the offset-indexed best-fit contract.
   Schema : constant Interfaces.Unsigned_64 := 16#0001_4246_4954_0001#;
   ...
   function Required_Storage
     (Configuration : Best_Fit_Kernel.Configuration) return Byte_Count;
