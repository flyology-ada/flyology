...
package body Gnatevl.IO is
   ...
   pragma Import
     (C, Runtime_Wait_IO_Many, "gnatevl_runtime_wait_io_many");
   ...
   begin
      ...
      begin
         ...
         --  also preserves native/evented parity when readiness and an
         --  already-expired scheduler deadline coincide.
         if Is_Evented_Task and then Timeout /= 0.0 then
