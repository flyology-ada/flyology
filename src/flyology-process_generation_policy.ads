...
is
   ...
   with Global => null,
        ...
        Post   => Phase_After'Result /= Public.Stable or else
   ...
   with Global => null,
        Post   => Cancellation_Allowed'Result =
   ...
   function Promotion_Committed
     (Phase : Public.Upgrade_Phase) return Boolean
   with Global => null,
        Post   => Promotion_Committed'Result =
          (Phase in Public.Promoting | Public.Draining_Previous |
             Public.Committing | Public.Completed |
             Public.Rollback_Required);
   ...
   with Global => null,
        ...
        Post   => Advanced'Result = Value + 1 and then
