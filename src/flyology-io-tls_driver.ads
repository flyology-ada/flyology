...
private package Flyology.IO.TLS_Driver is
   ...
   procedure Handshake_Once
     (Item : in out Flyology.IO.TLS.Session'Class; Status : out Flyology.IO.TLS.Step_Status);
   ...
   procedure Handshake
     (Item        : in out Flyology.IO.TLS.Session'Class;
      ...
      Await_Ready : not null access procedure (Status : Flyology.IO.TLS.Step_Status));
