...
package body Flyology.Execution_Groups is
   ...
   pragma Import
     (C,
      ...
      "flyology_runtime_configured_placement");

   function Runtime_Placement_Supported (Mode : C.int) return C.int;
   pragma Import
     (C, Runtime_Placement_Supported, "flyology_runtime_placement_supported");
   ...
   pragma Import
     (C, Runtime_Current_Processor, "flyology_runtime_current_processor");

   function Runtime_Create_Dedicated_Group return C.int;
   pragma Import
     (C,
      Runtime_Create_Dedicated_Group,
      "flyology_runtime_create_dedicated_group");

   function Runtime_Is_Dedicated_Group (Group : C.int) return C.int;
   pragma Import
     (C, Runtime_Is_Dedicated_Group, "flyology_runtime_is_dedicated_group");
   ...
   pragma Import
     (C, Runtime_Pin_Current_Thread, "flyology_runtime_pin_current_thread");

   function Runtime_Unpin_Current_Thread
     (Owner : System.Address) return C.int;
   pragma Import
     (C,
      Runtime_Unpin_Current_Thread,
      "flyology_runtime_unpin_current_thread");
