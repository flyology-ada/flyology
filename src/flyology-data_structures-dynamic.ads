...
--  grows through Flyology.Data_Structures.Arenas. "Dynamic" describes growth
--  within a caller-owned fixed arena; these packages do not resize mappings,
--  allocate process-local heap objects, or own backing-region lifetimes.
