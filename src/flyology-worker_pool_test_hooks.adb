...
package body Flyology.Worker_Pool_Test_Hooks is
   ...
   function Test_Run_Claim_Barrier_Arrive return Interfaces.C.int
     with Import,
          Convention => C,
          External_Name => "flyology_test_worker_run_claim_barrier_arrive";
   function Test_Run_Claim_Barrier_Released return Interfaces.C.int
     with Import,
          Convention => C,
          External_Name => "flyology_test_worker_run_claim_barrier_released";
   ...
   function Consume_Failure return Boolean is
     (Test_Consume_Failure /= 0);

   function Completion_Wake return Boolean is
     (Test_Completion_Wake /= 0);
   ...
   function Completion_Wake return Boolean is (False);
