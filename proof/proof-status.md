...
Findings #5 and #14 are prevented by production-consumed SPARK policies.
...
- [ ] Finding #16 chunk hexadecimal encoder
...
- [x] Boundary tests cover generation rollover and rate-refill saturation
