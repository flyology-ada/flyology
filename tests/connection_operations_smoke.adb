   ...
   begin
      ...
      begin
         ...
         declare
            ...
            Cancelled : Connections.Receive_Operation :=
              Connections.Receive
                (Set'Access, Item'Access, Data'Access, 1.0,
                 Token'Access);
         ...
         begin
            ...
            Connections.Receive
              (Item'Access, Data'Access, 0.005, null, Timed);
            Flyology.Operations.Wait_All (Set);
            begin
      ...
      begin
         ...
         begin
            ...
            exception
               when Flyology.IO.Device_Error => Exact_Failed := True;
            end;
         end;
         Passed := Passed
           and then Last = Data_1'First - 1
           and then Exact_Failed;
      ...
      begin
         ...
         Connections.Finish (Get);
         Connections.Send_All
           (Item'Access, Outgoing'Access, 1.0, null, Put);
         Flyology.Operations.Wait_All (Set);
         Connections.Finish (Put);
         ...
         begin
            ...
            exception
               when TLS.TLS_Error => Raised_TLS := True;
            end;
