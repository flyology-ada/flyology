...
package body Flyology.IO.Connections.Testing is
   ...
   procedure C_Fail_Next_Controller_Wake
   with
     Import,
     Convention    => C,
     External_Name => "flyology_test_connection_arm_controller_wake_failure";
   ...
   procedure Fail_Next_Controller_Wake is
   begin
      C_Fail_Next_Controller_Wake;
   end Fail_Next_Controller_Wake;
