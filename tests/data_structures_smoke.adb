...
procedure Data_Structures_Smoke is
   ...
   package Slab_Span_Arenas is new DS.Arenas (Algorithm => DS.Allocation_Algorithms.Slab_Span);
   ...
   package Best_Fit_Dynamic_Vectors is new
     DS.Dynamic.Vectors (Arena_Provider => Best_Fit_Arenas, Element => U64_Elements.Element);
   package TLSF_Dynamic_Vectors is new
     DS.Dynamic.Vectors (Arena_Provider => TLSF_Arenas, Element => U64_Elements.Element);
   ...
   function Create_Bytes_16 (Data : Bytes_16) return Bytes_16_Representation.Value is
      Item : Bytes_16_Representation.Value_Builder := Bytes_16_Representation.Start;
   begin
      for Index in Data'Range loop
         Bytes_16_Representation.Store_U8
           (Item, Natural (Index) - Natural (Data'First), Interfaces.Unsigned_8 (Data (Index)));
      end loop;
      return Bytes_16_Representation.Freeze (Item);
   end Create_Bytes_16;

   procedure Construct_Bytes_16 (Item : in out Bytes_16_Representation.Builder; Data : Bytes_16) is
   begin
      for Index in Data'Range loop
         Bytes_16_Representation.Store_U8
           (Item, Natural (Index) - Natural (Data'First), Interfaces.Unsigned_8 (Data (Index)));
   ...
   function Observe_Bytes_16 (Item : Bytes_16_Representation.Const_Ref) return Bytes_16 is
      Result : Bytes_16;
   begin
      for Index in Result'Range loop
         Result (Index) :=
           Ada.Streams.Stream_Element
             (Bytes_16_Representation.Load_U8 (Item, Natural (Index) - Natural (Result'First)));
      end loop;
      return Result;
   end Observe_Bytes_16;

   package Bytes_16_Element is new
   ...
   package Test_U64_Element is new
     DS.Storage_Types.Elements
   ...
   function Alternate_Create (Item : Interfaces.Unsigned_64) return Alternate_U64.Value is
   ...
   function Alternate_Observe (Item : Alternate_U64.Const_Ref) return Interfaces.Unsigned_64
   is (Alternate_U64.Load_U64 (Item, 0));

   package Alternate_Element is new
     DS.Storage_Types.Elements
   ...
   package Alternate_Bytes_16 is new
     DS.Storage_Types.Immutable
       (Byte_Size          => 16,
        Required_Alignment => 8,
   ...
   function Alternate_Bytes_16_Create (Data : Bytes_16) return Alternate_Bytes_16.Value is
   ...
   function Alternate_Bytes_16_Observe (Item : Alternate_Bytes_16.Const_Ref) return Bytes_16 is
      Result : Bytes_16;
   begin
      for Index in Result'Range loop
         Result (Index) :=
           Ada.Streams.Stream_Element
             (Alternate_Bytes_16.Load_U8 (Item, Natural (Index) - Natural (Result'First)));
      end loop;
      return Result;
   end Alternate_Bytes_16_Observe;

   package Alternate_Bytes_16_Element is new
     DS.Storage_Types.Elements
   ...
   package Alternate_U64_Version is new
     DS.Storage_Types.Immutable
       (Byte_Size          => 8,
        Required_Alignment => 8,
   ...
   function Alternate_Version_Create (Item : Interfaces.Unsigned_64) return Alternate_U64_Version.Value is
      Builder : Alternate_U64_Version.Value_Builder := Alternate_U64_Version.Start;
   begin
      Alternate_U64_Version.Store_U64 (Builder, 0, Item);
      return Alternate_U64_Version.Freeze (Builder);
   end Alternate_Version_Create;

   function Alternate_Version_Observe (Item : Alternate_U64_Version.Const_Ref) return Interfaces.Unsigned_64
   is (Alternate_U64_Version.Load_U64 (Item, 0));

   package Alternate_Version_Element is new
     DS.Storage_Types.Elements
   ...
   package Wrong_Version_Vectors is new DS.Vectors (Element => Alternate_Version_Element);
   package Wrong_Slabs is new DS.Slab_Pools (Element => Alternate_Bytes_16_Element);
   package Wrong_SPSC is new DS.Rings.SPSC (Element => Alternate_Element);
   package Wrong_MPMC is new DS.Rings.MPMC (Element => Alternate_Element);
   package Wrong_Maps is new DS.Hash_Maps (Key => Alternate_Element, Element => U64_Elements.Element);
   package Wrong_Dynamic_Vectors is new
     DS.Dynamic.Vectors (Arena_Provider => Arenas, Element => Alternate_Element);
   package Wrong_Dynamic_Maps is new
     DS.Dynamic.Hash_Maps
       (Arena_Provider => Arenas,
        Key            => U64_Elements.Element,
   ...
   package Maps is new DS.Hash_Maps (Key => U64_Elements.Element, Element => U64_Elements.Element);
   package Contract_V1 is new
     DS.Envelopes
       (Nested_Identity    => Vectors.Identity,
        Contract_Signature => 16#A17E_5B31_92C4_770D#,
        Contract_Version   => 1);
   package Contract_V2 is new
     DS.Envelopes
       (Nested_Identity    => Vectors.Identity,
        Contract_Signature => 16#A17E_5B31_92C4_770D#,
        Contract_Version   => 2);
   package Contract_Other is new
     DS.Envelopes
       (Nested_Identity    => Vectors.Identity,
        Contract_Signature => 16#D8C2_0A6E_47F1_B935#,
        Contract_Version   => 1);
   package Contract_Wrong_Leaf is new
     DS.Envelopes
   ...
   Best_Fit_Instance         : constant Interfaces.Unsigned_64 := 16#B35F_17A1_10C8_0001#;
   ...
   TLSF_Instance             : constant Interfaces.Unsigned_64 := 16#715F_17A1_10C8_0001#;
   ...
   Slab_Span_Configuration   : constant Slab_Span_Arenas.Configuration :=
     (Usable_Capacity => 8_192, Minimum_Block_Size => 64, Run_Size => 4_096);
   Slab_Span_Instance        : constant Interfaces.Unsigned_64 := 16#51AB_17A1_10C8_0001#;
   Envelope_Content_Extent   : constant DS.Byte_Count := Vectors.Required_Storage (4);
   ...
   function Unmap_And_Reserve (Address : System.Address; Length : C.size_t) return C.int;
   pragma Import (C, Unmap_And_Reserve, "flyology_test_mapping_unmap_and_reserve");

   function Remap (FD : C.int; Length : C.size_t; Address : access System.Address) return C.int;
   ...
   procedure Write_U32 (Base : System.Address; Offset : C.size_t; Value : Interfaces.Unsigned_32);
   pragma Import (C, Write_U32, "flyology_test_mapping_write_u32");

   procedure Write_U64 (Base : System.Address; Offset : C.size_t; Value : Interfaces.Unsigned_64);
   ...
   is
      ...
      Values     : array (Positive range 1 .. Slot_Count) of Interfaces.Unsigned_64 := [others => 0];
   ...
   begin
      for Step in 1 .. 20_000 loop
         ...
         Index := Positive (Natural (Seed mod Slot_Count) + 1);
         if Live (Index) then
            ...
            Assert (Decode (Data) = Values (Index), "variable-size allocator stress corrupted a payload");
            Live (Index) := False;
         else
            Size := Positive (Natural (Interfaces.Shift_Right (Seed, 17) mod 2_048) + 1);
            if Step mod 2 = 0 then
               Provider.Try_Allocate (First, Size, Handles (Index), Result);
            else
               Provider.Try_Allocate (Second, Size, Handles (Index), Result);
            end if;
            if Result = Provider.Allocated then
               Values (Index) := Interfaces.Unsigned_64 (Index) * 1_000_000 + Interfaces.Unsigned_64 (Step);
               if Step mod 2 = 0 then
                  Provider.Write (Second, Handles (Index), 0, Encode (Values (Index)));
               else
                  Provider.Write (First, Handles (Index), 0, Encode (Values (Index)));
               end if;
               Live (Index) := True;
            elsif Result /= Provider.Exhausted then
               raise Program_Error with "single-task allocator stress observed contention";
            end if;
         end if;
   ...
   procedure Stress_Best_Fit is new Stress_Variable_Arena (Provider => Best_Fit_Arenas);
   procedure Stress_TLSF is new Stress_Variable_Arena (Provider => TLSF_Arenas);

   function Test_Hash (Key : Ada.Streams.Stream_Element_Array) return Interfaces.Unsigned_64 is
   ...
   function Raw_Offset (Location : DS.Region_Offset; Relative : Natural) return C.size_t
   is (C.size_t (DS.Byte_Count (Location) + DS.Byte_Count (Relative)));

   function Map_Entry_Offset (Index : Interfaces.Unsigned_64; Relative : Natural) return C.size_t
   is (Raw_Offset (Map_Location, 72 + Natural (Index) * 32 + Relative));
   ...
   Best_Fit_A, Best_Fit_B, Best_Fit_C, Best_Fit_Bad        : Best_Fit_Arenas.View;
   ...
   Dynamic_Vector_A, Dynamic_Vector_B, Dynamic_Vector_C    : Dynamic_Vectors.View;
   Dynamic_Vector_Bad                                      : Dynamic_Vectors.View;
   Scratch_Dynamic_A, Scratch_Dynamic_B                    : Dynamic_Vectors.View;
   Dynamic_String_A, Dynamic_String_B, Dynamic_String_C    : Dynamic_Strings.View;
   Dynamic_Map_A, Dynamic_Map_B, Dynamic_Map_C             : Dynamic_Maps.View;
   Dynamic_Map_Bad                                         : Dynamic_Maps.View;
   Best_Fit_Vector_A, Best_Fit_Vector_B, Best_Fit_Vector_C : Best_Fit_Dynamic_Vectors.View;
   TLSF_Vector_A, TLSF_Vector_B, TLSF_Vector_C             : TLSF_Dynamic_Vectors.View;
   ...
   Payload_16        : Ada.Streams.Stream_Element_Array (1 .. 16) := (others => 16#2A#);
   Arena_Data        : constant Ada.Streams.Stream_Element_Array (1 .. 16) := (others => 16#A7#);
   ...
   String_Data       : constant Ada.Streams.Stream_Element_Array :=
     [1 => Character'Pos ('f'), 2 => Character'Pos ('l'), 3 => Character'Pos ('y')];
   ...
   type Adaptive_Handle_Array is array (Positive range <>) of Adaptive_U64.Handle;
   ...
   Bad_Handles       : constant Handle_Array :=
     [Handles.Null_Handle, (Slot => 99, Stamp => 1), (Slot => 1, Stamp => 0)];
   Flag              : Boolean;
...
begin
   ...
   declare
      ...
      Appended      : Boolean;
   begin
      Regions.Attach (Local_Region, Local_Storage'Address, DS.Byte_Count (Local_Storage'Length));
      Wrong_Vectors.Create_Or_Attach (Local_Vector, Local_Region, 64, 4, Outcome);
      Assert (Outcome = DS.Initialized_New, "fallback-adapter vector was not created");
   ...
   Arenas.Create_Or_Attach
     (Arena_B,
      ...
      16#A8E4_7B19_2C63_D501#,
      Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "arena was reinitialized");

   declare
      Saved        : constant Interfaces.Unsigned_32 := Read_U32 (Base_B, Raw_Offset (Arena_Location, 4));
      Saved_Schema : constant Interfaces.Unsigned_64 := Read_U64 (Base_B, Raw_Offset (Arena_Location, 16));
      Failed       : Boolean := False;
   begin
      Write_U32 (Base_B, Raw_Offset (Arena_Location, 4), 2);
      Write_U64 (Base_B, Raw_Offset (Arena_Location, 16), 16#0001_4152_454E_0002#);
      begin
         Arenas.Attach
           (Arena_Bad,
            Region_B,
      ...
      Write_U64 (Base_B, Raw_Offset (Arena_Location, 16), Saved_Schema);
      Assert
   ...
   begin
      ...
      Assert
        (Failed and then not Arenas.Is_Attached (Arena_Bad), "arena accepted incompatible managed capacity");
   ...
   Assert
     (Arena_Allocation = Arenas.Allocated and then Arenas.Block_Capacity (Arena_B, Arena_Handle) = 64,
   ...
   Assert
     (Arena_Allocation = Arenas.Allocated and then Arenas.Block_Capacity (Arena_A, Arena_Released) = 8_192,
   ...
   Dynamic_Vectors.Create_Or_Attach
     (Dynamic_Vector_A, Region_A, Dynamic_Vector_Location, Arena_A, 2, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "dynamic vector was not created");
   Dynamic_Vectors.Create_Or_Attach
     (Dynamic_Vector_B, Region_B, Dynamic_Vector_Location, Arena_B, 2, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "dynamic vector was reinitialized");
   for Index in 1 .. 20 loop
      Dynamic_Vectors.Try_Append (Dynamic_Vector_A, Arena_A, Interfaces.Unsigned_64 (Index), Growth);
      Assert (Growth = DS.Dynamic.Completed, "dynamic vector failed to grow in its arena");
   end loop;
   Assert
   ...
   Assert (U64_Value = 20, "dynamic-vector payload was not shared across mappings");

   Dynamic_Strings.Create_Or_Attach
     (Dynamic_String_A, Region_A, Dynamic_String_Location, Arena_A, 4, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "dynamic byte string was not created");
   Dynamic_Strings.Create_Or_Attach
     (Dynamic_String_B, Region_B, Dynamic_String_Location, Arena_B, 4, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "dynamic byte string was reinitialized");
   Dynamic_Strings.Try_Append (Dynamic_String_A, Arena_A, String_Data, Growth);
   Assert (Growth = DS.Dynamic.Completed, "dynamic string append failed");
   Dynamic_Strings.Try_Append (Dynamic_String_B, Arena_B, String_More, Growth);
   Assert
     (Growth = DS.Dynamic.Completed and then Dynamic_Strings.Length (Dynamic_String_A) = 8,
      "dynamic byte string did not grow across mappings");
   Dynamic_Strings.Read (Dynamic_String_A, Arena_A, String_Read);
   Assert
     (String_Read (1 .. 3) = String_Data and then String_Read (4 .. 8) = String_More,
      "dynamic byte-string payload order is wrong");

   Dynamic_Maps.Create_Or_Attach (Dynamic_Map_A, Region_A, Dynamic_Map_Location, Arena_A, 2, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "dynamic map was not created");
   Dynamic_Maps.Create_Or_Attach (Dynamic_Map_B, Region_B, Dynamic_Map_Location, Arena_B, 2, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "dynamic map was reinitialized");
   for Index in Interfaces.Unsigned_64 range 1 .. 20 loop
      Dynamic_Maps.Put (Dynamic_Map_A, Arena_A, Index, Index * 10, Dynamic_Put);
      Assert (Dynamic_Put = Dynamic_Maps.Put_Inserted, "dynamic map failed to insert while growing");
   end loop;
   Dynamic_Maps.Get (Dynamic_Map_B, Arena_B, 20, U64_Value, Flag);
   Assert
     (Flag
      and then U64_Value = 200
   ...
   Best_Fit_Arenas.Create_Or_Attach
     (Best_Fit_A, Region_A, Best_Fit_Arena_Location, Best_Fit_Configuration, Best_Fit_Instance, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "best-fit arena was not created");
   Best_Fit_Arenas.Create_Or_Attach
     (Best_Fit_B, Region_B, Best_Fit_Arena_Location, Best_Fit_Configuration, Best_Fit_Instance, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "best-fit arena was reinitialized");
   declare
      Saved_Version : constant Interfaces.Unsigned_32 :=
        Read_U32 (Base_B, Raw_Offset (Best_Fit_Arena_Location, 4));
      Saved_Schema  : constant Interfaces.Unsigned_64 :=
        Read_U64 (Base_B, Raw_Offset (Best_Fit_Arena_Location, 16));
      Failed        : Boolean := False;
   begin
      Write_U32 (Base_B, Raw_Offset (Best_Fit_Arena_Location, 4), 2);
      Write_U64 (Base_B, Raw_Offset (Best_Fit_Arena_Location, 16), 16#0001_4246_4954_0002#);
      begin
         Best_Fit_Arenas.Attach
           (Best_Fit_Bad, Region_B, Best_Fit_Arena_Location, Best_Fit_Configuration, Best_Fit_Instance);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      Write_U32 (Base_B, Raw_Offset (Best_Fit_Arena_Location, 4), Saved_Version);
      Write_U64 (Base_B, Raw_Offset (Best_Fit_Arena_Location, 16), Saved_Schema);
      Assert
   ...
   declare
      type Best_Fit_Handle_Array is array (Positive range <>) of Best_Fit_Arenas.Allocation_Handle;
      Handles  : Best_Fit_Handle_Array (1 .. 5);
      Selected : Best_Fit_Arenas.Allocation_Handle;
      Sizes    : constant array (Positive range 1 .. 5) of Positive := [100, 200, 100, 400, 100];
   begin
      for Index in Handles'Range loop
         Best_Fit_Arenas.Try_Allocate (Best_Fit_A, Sizes (Index), Handles (Index), Arena_Allocation);
         Assert
           (Arena_Allocation = Best_Fit_Arenas.Allocated, "best-fit arena rejected an available allocation");
      end loop;
      Best_Fit_Arenas.Release (Best_Fit_B, Handles (2));
      Best_Fit_Arenas.Release (Best_Fit_A, Handles (4));

      Best_Fit_Arenas.Try_Allocate (Best_Fit_B, 180, Selected, Arena_Allocation);
      Assert
        (Arena_Allocation = Best_Fit_Arenas.Allocated
         and then Best_Fit_Arenas.Block_Capacity (Best_Fit_A, Selected) = 256,
         "best-fit arena did not choose the smallest fitting block");
      Best_Fit_Arenas.Release (Best_Fit_A, Selected);

      Best_Fit_Arenas.Try_Allocate (Best_Fit_A, 300, Selected, Arena_Allocation);
      Assert
        (Arena_Allocation = Best_Fit_Arenas.Allocated
         and then Best_Fit_Arenas.Block_Capacity (Best_Fit_B, Selected) = 320,
      ...
      Best_Fit_Arenas.Try_Allocate (Best_Fit_B, 65_000, Selected, Arena_Allocation);
      Assert
        (Arena_Allocation = Best_Fit_Arenas.Allocated
         and then Best_Fit_Arenas.Block_Capacity (Best_Fit_A, Selected) = 65_024,
         "best-fit arena did not coalesce adjacent free blocks");
      Best_Fit_Arenas.Release (Best_Fit_A, Selected);
   end;

   Stress_Best_Fit
     (Best_Fit_A, Best_Fit_B, Region_B, Best_Fit_Arena_Location, Best_Fit_Configuration, Best_Fit_Instance);

   Best_Fit_Arenas.Try_Allocate (Best_Fit_A, 33, Best_Fit_Handle, Arena_Allocation);
   Assert
     (Arena_Allocation = Best_Fit_Arenas.Allocated
      and then Best_Fit_Arenas.Block_Capacity (Best_Fit_B, Best_Fit_Handle) = 64,
      "best-fit arena did not expose its rounded payload capacity");
   Best_Fit_Arenas.Write (Best_Fit_A, Best_Fit_Handle, 0, Arena_Data);
   Best_Fit_Arenas.Read (Best_Fit_B, Best_Fit_Handle, 0, Read_16);
   Assert (Read_16 = Arena_Data, "best-fit payload was not shared across mappings");

   Best_Fit_Dynamic_Vectors.Create_Or_Attach
     (Best_Fit_Vector_A, Region_A, Best_Fit_Dynamic_Location, Best_Fit_A, 2, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "best-fit dynamic vector was not created");
   Best_Fit_Dynamic_Vectors.Create_Or_Attach
     (Best_Fit_Vector_B, Region_B, Best_Fit_Dynamic_Location, Best_Fit_B, 2, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "best-fit dynamic vector was reinitialized");
   for Index in 1 .. 40 loop
      Best_Fit_Dynamic_Vectors.Try_Append
        (Best_Fit_Vector_A, Best_Fit_A, Interfaces.Unsigned_64 (Index), Growth);
      Assert (Growth = DS.Dynamic.Completed, "best-fit dynamic vector failed to grow");
   end loop;
   Assert
     (Best_Fit_Dynamic_Vectors.Read (Best_Fit_Vector_B, Best_Fit_B, 40) = 40,
      "best-fit dynamic vector was not shared across mappings");

   declare
      Saved  : constant Interfaces.Unsigned_32 :=
        Read_U32 (Base_B, Raw_Offset (Best_Fit_Arena_Location, 228));
      Failed : Boolean := False;
   begin
      Write_U32 (Base_B, Raw_Offset (Best_Fit_Arena_Location, 228), 1);
      begin
         Best_Fit_Arenas.Attach
           (Best_Fit_Bad, Region_B, Best_Fit_Arena_Location, Best_Fit_Configuration, Best_Fit_Instance);
      exception
      ...
      Write_U32 (Base_B, Raw_Offset (Best_Fit_Arena_Location, 228), Saved);
      Assert
        (Failed and then not Best_Fit_Arenas.Is_Attached (Best_Fit_Bad),
   ...
   Assert
     (Arenas.Capabilities.Search = DS.Allocation_Algorithms.Linear
      ...
      and then Best_Fit_Arenas.Capabilities.Search = DS.Allocation_Algorithms.Linear
      and then not Best_Fit_Arenas.Capabilities.Coalesces_On_Release
      and then TLSF_Arenas.Capabilities.Search = DS.Allocation_Algorithms.Linear
   ...
   TLSF_Arenas.Create_Or_Attach
     (TLSF_A, Region_A, TLSF_Arena_Location, TLSF_Configuration, TLSF_Instance, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "TLSF arena was not created");
   TLSF_Arenas.Create_Or_Attach
     (TLSF_B, Region_B, TLSF_Arena_Location, TLSF_Configuration, TLSF_Instance, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "TLSF arena was reinitialized");
   declare
      Saved_Version : constant Interfaces.Unsigned_32 :=
        Read_U32 (Base_B, Raw_Offset (TLSF_Arena_Location, 4));
      Saved_Schema  : constant Interfaces.Unsigned_64 :=
        Read_U64 (Base_B, Raw_Offset (TLSF_Arena_Location, 16));
      Failed        : Boolean := False;
   begin
      Write_U32 (Base_B, Raw_Offset (TLSF_Arena_Location, 4), 2);
      Write_U64 (Base_B, Raw_Offset (TLSF_Arena_Location, 16), 16#0001_544C_5346_0002#);
      begin
         TLSF_Arenas.Attach (TLSF_Bad, Region_B, TLSF_Arena_Location, TLSF_Configuration, TLSF_Instance);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      Write_U32 (Base_B, Raw_Offset (TLSF_Arena_Location, 4), Saved_Version);
      Write_U64 (Base_B, Raw_Offset (TLSF_Arena_Location, 16), Saved_Schema);
      Assert
   ...
   begin
      ...
      Assert
        (Failed and then not TLSF_Arenas.Is_Attached (TLSF_Bad), "TLSF arena accepted incompatible geometry");
   end;

   declare
      type TLSF_Handle_Array is array (Positive range <>) of TLSF_Arenas.Allocation_Handle;
      Handles  : TLSF_Handle_Array (1 .. 5);
      Selected : TLSF_Arenas.Allocation_Handle;
      Sizes    : constant array (Positive range 1 .. 5) of Positive := [100, 200, 100, 400, 100];
   begin
      for Index in Handles'Range loop
         TLSF_Arenas.Try_Allocate (TLSF_A, Sizes (Index), Handles (Index), Arena_Allocation);
         Assert (Arena_Allocation = TLSF_Arenas.Allocated, "TLSF arena rejected an available allocation");
      end loop;
      TLSF_Arenas.Release (TLSF_B, Handles (2));
      TLSF_Arenas.Release (TLSF_A, Handles (4));
      TLSF_Arenas.Try_Allocate (TLSF_B, 180, Selected, Arena_Allocation);
      Assert
      ...
      TLSF_Arenas.Try_Allocate (TLSF_A, 300, Selected, Arena_Allocation);
      Assert
        (Arena_Allocation = TLSF_Arenas.Allocated
      ...
      TLSF_Arenas.Try_Allocate (TLSF_B, 65_400, Selected, Arena_Allocation);
      Assert
        (Arena_Allocation = TLSF_Arenas.Allocated
         and then TLSF_Arenas.Block_Capacity (TLSF_A, Selected) = 65_472,
         "TLSF did not coalesce its complete managed extent");
      TLSF_Arenas.Release (TLSF_A, Selected);
   end;

   Stress_TLSF (TLSF_A, TLSF_B, Region_B, TLSF_Arena_Location, TLSF_Configuration, TLSF_Instance);

   TLSF_Arenas.Try_Allocate (TLSF_A, 33, TLSF_Handle, Arena_Allocation);
   Assert
     (Arena_Allocation = TLSF_Arenas.Allocated and then TLSF_Arenas.Block_Capacity (TLSF_B, TLSF_Handle) = 64,
   ...
   Assert (Read_16 = Arena_Data, "TLSF payload was not shared across mappings");

   TLSF_Dynamic_Vectors.Create_Or_Attach
     (TLSF_Vector_A, Region_A, TLSF_Dynamic_Location, TLSF_A, 2, Open_Outcome);
   TLSF_Dynamic_Vectors.Create_Or_Attach
     (TLSF_Vector_B, Region_B, TLSF_Dynamic_Location, TLSF_B, 2, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "TLSF dynamic vector was not attached");
   for Index in 1 .. 40 loop
      TLSF_Dynamic_Vectors.Try_Append (TLSF_Vector_A, TLSF_A, Interfaces.Unsigned_64 (Index), Growth);
      Assert (Growth = DS.Dynamic.Completed, "TLSF dynamic vector failed to grow");
   end loop;
   Assert
   ...
   declare
      Saved  : constant Interfaces.Unsigned_32 := Read_U32 (Base_B, Raw_Offset (TLSF_Arena_Location, 128));
      Failed : Boolean := False;
   begin
      Write_U32 (Base_B, Raw_Offset (TLSF_Arena_Location, 128), Saved xor 1);
      begin
         TLSF_Arenas.Attach (TLSF_Bad, Region_B, TLSF_Arena_Location, TLSF_Configuration, TLSF_Instance);
      exception
         when DS.Layout_Error =>
      ...
      Write_U32 (Base_B, Raw_Offset (TLSF_Arena_Location, 128), Saved);
      Assert
        (Failed and then not TLSF_Arenas.Is_Attached (TLSF_Bad),
   ...
   Slab_Span_Arenas.Create_Or_Attach
     (Slab_Span_A,
      Region_A,
      Slab_Span_Arena_Location,
      Slab_Span_Configuration,
      Slab_Span_Instance,
      Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "slab/span Flyology bridge was not created");
   Slab_Span_Arenas.Create_Or_Attach
     (Slab_Span_B,
      Region_B,
      Slab_Span_Arena_Location,
      ...
      Slab_Span_Instance,
      Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "slab/span Flyology bridge was reinitialized");
   declare
      Result : Slab_Span_Arenas.Allocation_Result;
   begin
      Slab_Span_Arenas.Try_Allocate (Slab_Span_A, 65, Slab_Span_Handle, Result);
      Assert
        (Result = Slab_Span_Arenas.Allocated
         and then Slab_Span_Arenas.Block_Capacity (Slab_Span_B, Slab_Span_Handle) = 128,
         "slab/span Flyology bridge allocation failed");
   end;
   Slab_Span_Arenas.Write (Slab_Span_A, Slab_Span_Handle, 0, Arena_Data);
   Slab_Span_Arenas.Read (Slab_Span_B, Slab_Span_Handle, 0, Read_16);
   Assert (Read_16 = Arena_Data, "slab/span Flyology bridge payload was not shared");
   ...
   Adaptive_U64.Create_Or_Attach (Adaptive_A, Region_A, Adaptive_Pool_Location, TLSF_A, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "adaptive pool was not created");
   Adaptive_U64.Create_Or_Attach (Adaptive_B, Region_B, Adaptive_Pool_Location, TLSF_B, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "adaptive pool was reinitialized");
   for Index in Adaptive_Handles'Range loop
      declare
         Result : Adaptive_U64.Allocation_Result;
      begin
         Adaptive_U64.Try_Allocate
           (Adaptive_A, TLSF_A, Interfaces.Unsigned_64 (Index), Adaptive_Handles (Index), Result);
         Assert (Result = Adaptive_U64.Allocated, "adaptive pool failed to add or allocate a chunk");
      end;
   end loop;
   Adaptive_U64.Read (Adaptive_B, TLSF_B, Adaptive_Handles (40), U64_Value);
   Assert
   ...
   begin
      begin
         Adaptive_U64.Release (Adaptive_A, TLSF_A, Adaptive_Handles (1));
      exception
         when DS.Handle_Error =>
            Failed := True;
      end;
   ...
   declare
      Saved  : constant Interfaces.Unsigned_32 := Read_U32 (Base_B, Raw_Offset (Adaptive_Pool_Location, 80));
      Failed : Boolean := False;
   begin
      Write_U32 (Base_B, Raw_Offset (Adaptive_Pool_Location, 80), 99);
      begin
      ...
      Write_U32 (Base_B, Raw_Offset (Adaptive_Pool_Location, 80), Saved);
      Assert
      ...
      Failed := False;
      begin
         Adaptive_U64.Attach (Adaptive_Bad, Region_B, Adaptive_Pool_Location, TLSF_Bad);
      exception
         when DS.Region_Error =>
            Failed := True;
      end;
      Assert
        (Failed and then not Adaptive_U64.Is_Attached (Adaptive_Bad),
   ...
   declare
      ...
      Foreign_Configuration  : constant TLSF_Arenas.Configuration :=
        (Usable_Capacity => 16_384, Minimum_Block_Size => 64);
      Foreign_Instance       : constant Interfaces.Unsigned_64 := 16#715F_17A1_10C8_0002#;
   ...
   begin
      TLSF_Arenas.Initialize
        (Foreign_Arena, Region_A, Foreign_Arena_Location, Foreign_Configuration, Foreign_Instance);
      begin
         Adaptive_U64.Read (Adaptive_A, Foreign_Arena, Adaptive_Handles (40), U64_Value);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      ...
      Failed := False;
      begin
         Adaptive_U64.Try_Allocate (Adaptive_A, Foreign_Arena, 7, Foreign_Handle, Foreign_Result);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      ...
      Adaptive_U64.Initialize (Foreign_Pool, Region_A, Foreign_Pool_Location, Foreign_Arena);
      Adaptive_U64.Try_Allocate (Foreign_Pool, Foreign_Arena, 5, Foreign_Handle, Foreign_Result);
      Assert
        (Foreign_Result = Adaptive_U64.Allocated, "scratch adaptive pool did not allocate its first chunk");
      TLSF_Arenas.Initialize
        (Foreign_Arena, Region_A, Foreign_Arena_Location, Foreign_Configuration, Foreign_Instance);
      Failed := False;
      begin
         Adaptive_U64.Read (Foreign_Pool, Foreign_Arena, Foreign_Handle, U64_Value);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      ...
      declare
         ...
         Saved_State                 : constant Interfaces.Unsigned_32 :=
           Read_U32 (Base_A, Raw_Offset (Foreign_Pool_Location, 0));
      begin
         TLSF_Arenas.Initialize
           (Foreign_Arena, Region_A, Foreign_Arena_Location, Low_Alignment_Configuration, Foreign_Instance);
         Failed := False;
         begin
            Adaptive_U64.Initialize (Foreign_Pool, Region_A, Foreign_Pool_Location, Foreign_Arena);
         exception
         ...
         Assert
           (Failed
            ...
            and then Read_U32 (Base_A, Raw_Offset (Foreign_Pool_Location, 0)) = Saved_State,
   ...
   Arenas.Attach
     (Scratch_Arena_B,
      ...
      16#C0DE_0110_CAFE_0001#);
   declare
      type Arena_Handle_Array is array (Positive range <>) of Arenas.Allocation_Handle;
      Values : Arena_Handle_Array (1 .. 16);
      Extra  : Arenas.Allocation_Handle;
   begin
      for Index in Values'Range loop
         Arenas.Try_Allocate (Scratch_Arena_A, 1, Values (Index), Arena_Allocation);
         Assert (Arena_Allocation = Arenas.Allocated, "arena rejected an available minimum block");
         Arenas.Write (Scratch_Arena_A, Values (Index), 0, Encode (Interfaces.Unsigned_64 (Index)));
      end loop;
      Arenas.Try_Allocate (Scratch_Arena_A, 1, Extra, Arena_Allocation);
      Assert
        (Arena_Allocation = Arenas.Exhausted and then Extra = Arenas.Null_Allocation,
   ...
   Dynamic_Vectors.Initialize (Scratch_Dynamic_A, Region_A, Scratch_Dynamic_Location, Scratch_Arena_A, 2);
   Dynamic_Vectors.Try_Append (Scratch_Dynamic_A, Scratch_Arena_A, 77, Growth);
   Assert (Growth = DS.Dynamic.Completed, "scratch dynamic vector did not allocate from its arena");
   ...
   begin
      begin
         Dynamic_Vectors.Attach (Scratch_Dynamic_B, Region_B, Scratch_Dynamic_Location, Scratch_Arena_B, 2);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
   ...
   declare
      Failed                : Boolean := False;
      Saved_Node            : constant Interfaces.Unsigned_32 :=
        Read_U32 (Base_B, Raw_Offset (Dynamic_Vector_Location, 72));
      Saved_Vector_Capacity : constant Interfaces.Unsigned_64 :=
        Read_U64 (Base_B, Raw_Offset (Dynamic_Vector_Location, 64));
      Saved_String_Capacity : constant Interfaces.Unsigned_64 :=
        Read_U64 (Base_B, Raw_Offset (Dynamic_String_Location, 64));
      Saved_Map_Capacity    : constant Interfaces.Unsigned_64 :=
        Read_U64 (Base_B, Raw_Offset (Dynamic_Map_Location, 64));
      Saved_Map_Node        : constant Interfaces.Unsigned_32 :=
        Read_U32 (Base_B, Raw_Offset (Dynamic_Map_Location, 72));
      Saved_Reserved        : constant Interfaces.Unsigned_32 :=
        Read_U32 (Base_B, Raw_Offset (Arena_Location, 132));
   begin
      begin
         Dynamic_Vectors.Create_Or_Attach
           (Dynamic_Vector_Bad, Region_B, Dynamic_Vector_Location, Arena_B, 4, Open_Outcome);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      ...
      Write_U64 (Base_B, Raw_Offset (Dynamic_Vector_Location, 64), Saved_Vector_Capacity xor 1);
      Failed := False;
      begin
      ...
      Write_U64 (Base_B, Raw_Offset (Dynamic_Vector_Location, 64), Saved_Vector_Capacity);
      Assert (Failed, "dynamic vector ignored a corrupt capacity field");

      Write_U64 (Base_B, Raw_Offset (Dynamic_String_Location, 64), Saved_String_Capacity xor 1);
      Failed := False;
      begin
      ...
      Write_U64 (Base_B, Raw_Offset (Dynamic_String_Location, 64), Saved_String_Capacity);
      Assert (Failed, "dynamic byte string ignored corrupt capacity");

      Write_U64 (Base_B, Raw_Offset (Dynamic_Map_Location, 64), Saved_Map_Capacity xor 1);
      Failed := False;
      begin
      ...
      Write_U64 (Base_B, Raw_Offset (Dynamic_Map_Location, 64), Saved_Map_Capacity);
      Assert (Failed, "dynamic map ignored a corrupt capacity field");

      Write_U32 (Base_B, Raw_Offset (Dynamic_Vector_Location, 72), Interfaces.Unsigned_32'Last);
      Failed := False;
      begin
         Dynamic_Vectors.Attach (Dynamic_Vector_Bad, Region_B, Dynamic_Vector_Location, Arena_B, 2);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      Write_U32 (Base_B, Raw_Offset (Dynamic_Vector_Location, 72), Saved_Node);
      Assert
        (Failed and then not Dynamic_Vectors.Is_Attached (Dynamic_Vector_Bad),
      ...
      Write_U32 (Base_B, Raw_Offset (Arena_Location, 132), Saved_Reserved);
      Assert
        (Failed and then not Arenas.Is_Attached (Arena_Bad), "arena accepted corrupt buddy-node metadata");
      ...
      Write_U32 (Base_B, Raw_Offset (Dynamic_Map_Location, 72), Interfaces.Unsigned_32'Last);
      Failed := False;
      begin
         Dynamic_Maps.Attach (Dynamic_Map_Bad, Region_B, Dynamic_Map_Location, Arena_B, 2);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      Write_U32 (Base_B, Raw_Offset (Dynamic_Map_Location, 72), Saved_Map_Node);
      Assert
   ...
   Slabs.Create_Or_Attach (Slab_A, Region_A, Slab_Location, 8, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "slab was not created");
   Slabs.Create_Or_Attach (Slab_B, Region_B, Slab_Location, 8, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "slab was reinitialized");
   Strings.Create_Or_Attach (String_A, Region_A, String_Location, 128, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "string was not created");
   Strings.Create_Or_Attach (String_B, Region_B, String_Location, 128, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "string was reinitialized");
   Vectors.Create_Or_Attach (Vector_A, Region_A, Vector_Location, 16, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "vector was not created");
   Vectors.Create_Or_Attach (Vector_B, Region_B, Vector_Location, 16, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "vector was reinitialized");
   SPSC.Create_Or_Attach (Ring_A, Region_A, SPSC_Location, 16, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "SPSC ring was not created");
   SPSC.Create_Or_Attach (Ring_B, Region_B, SPSC_Location, 16, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "SPSC ring was reinitialized");
   MPMC.Create_Or_Attach (Multi_A, Region_A, MPMC_Location, 16, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "MPMC ring was not created");
   MPMC.Create_Or_Attach (Multi_B, Region_B, MPMC_Location, 16, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "MPMC ring was reinitialized");
   Maps.Create_Or_Attach (Map_A, Region_A, Map_Location, 16, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "map was not created");
   Maps.Create_Or_Attach (Map_B, Region_B, Map_Location, 16, Open_Outcome);
   ...
   begin
      ...
      Failed := False;
      begin
         Wrong_Dynamic_Vectors.Attach (Bad_Vector, Region_B, Dynamic_Vector_Location, Arena_B, 2);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      Assert (Failed, "dynamic vector accepted another element signature");

      Failed := False;
      begin
         Wrong_Dynamic_Maps.Attach (Bad_Dynamic_Map, Region_B, Dynamic_Map_Location, Arena_B, 2);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      Assert (Failed, "dynamic map accepted another value signature");
   end;
   Contract_V1.Create_Or_Attach
     (Envelope_A, Region_A, Envelope_Location, Envelope_Content_Extent, 8, Open_Outcome);
   Assert (Open_Outcome = DS.Initialized_New, "envelope was not created");
   Vectors.Create_Or_Attach (Wrapped_B, Region_B, Contract_V1.Content_Location (Envelope_A), 4, Open_Outcome);
   Assert
     (Open_Outcome = DS.Initialization_In_Progress and then not Vectors.Is_Attached (Wrapped_B),
      "nested initializer claim was not observable");
   Vectors.Initialize (Wrapped_A, Region_A, Contract_V1.Content_Location (Envelope_A), 4);
   Contract_V1.Create_Or_Attach
     (Envelope_B, Region_B, Envelope_Location, Envelope_Content_Extent, 8, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "envelope was reinitialized");
   Vectors.Create_Or_Attach (Wrapped_B, Region_B, Contract_V1.Content_Location (Envelope_B), 4, Open_Outcome);
   Assert (Open_Outcome = DS.Attached_Existing, "nested vector was reinitialized");

   declare
      Wrong       : Vectors.View;
      Failed      : Boolean := False;
      Saved_State : constant Interfaces.Unsigned_32 := Read_U32 (Base_B, Raw_Offset (Vector_Location, 0));
   begin
      begin
         Vectors.Create_Or_Attach (Wrong, Region_B, Vector_Location, 8, Open_Outcome);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      Assert
        (Failed
         and then not Vectors.Is_Attached (Wrong)
         and then Read_U32 (Base_B, Raw_Offset (Vector_Location, 0)) = Saved_State,
      ...
      begin
         Failed := False;
         begin
            Wrong_Vectors.Attach (Wrong_Element, Region_B, Vector_Location, 16);
         exception
            when DS.Layout_Error =>
               Failed := True;
         end;
         ...
         Failed := False;
         begin
            Wrong_Version_Vectors.Attach (Wrong_Version, Region_B, Vector_Location, 16);
         exception
            when DS.Layout_Error =>
               Failed := True;
         end;
         Assert
           (Failed and then not Wrong_Version_Vectors.Is_Attached (Wrong_Version),
            "vector accepted a different immutable element version");
      end;

      Write_U32 (Base_A, Raw_Offset (Scratch_Open_Location, 0), 16#FFFF_FFFA#);
      Failed := False;
      begin
         Vectors.Create_Or_Attach (Wrong, Region_A, Scratch_Open_Location, 4, Open_Outcome);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
      Assert
        (Failed
         and then not Vectors.Is_Attached (Wrong)
         and then Read_U32 (Base_B, Raw_Offset (Scratch_Open_Location, 0)) = 16#FFFF_FFFA#,
         "create-or-attach treated a corrupt nonzero state as virgin");
      Write_U32 (Base_A, Raw_Offset (Scratch_Open_Location, 0), 0);
   end;

   Assert
     (Contains_U64 (Base_A, Mapping_Length, Interfaces.Unsigned_64 (SSE.To_Integer (Base_A))) = 0,
      "mapping A address escaped into stored bytes");
   Assert
     (Contains_U64 (Base_A, Mapping_Length, Interfaces.Unsigned_64 (SSE.To_Integer (Base_B))) = 0,
   ...
   declare
      ...
      Failed           : Boolean := False;
   begin
      MPMC.Initialize (Small_A, Region_A, Scratch_MPMC_Location, 2);
      MPMC.Attach (Small_B, Region_B, Scratch_MPMC_Location, 2);
      MPMC.Try_Push (Small_A, 99, Push_Outcome);
      Assert (Push_Outcome = MPMC.Pushed, "capacity-two MPMC setup push failed");
      ...
      Write_U64 (Base_B, Raw_Offset (Scratch_MPMC_Location, 128), 1);
      begin
      ...
      for Round in Interfaces.Unsigned_64 range 1 .. 128 loop
         ...
         Assert (Push_Outcome = MPMC.Pushed, "capacity-two MPMC rejected its first slot");
         MPMC.Try_Push (Small_B, Round * 2, Push_Outcome);
         Assert (Push_Outcome = MPMC.Pushed, "capacity-two MPMC rejected its second slot");
         MPMC.Try_Push (Small_A, 0, Push_Outcome);
         Assert (Push_Outcome = MPMC.Full, "capacity-two MPMC did not report full");
         if Round = 1 then
            Failed := False;
            begin
         ...
         Assert
           (Pop_Outcome = MPMC.Popped and then U64_Value = Round * 2 - 1,
            "capacity-two MPMC lost FIFO order at wraparound");
         MPMC.Try_Pop (Small_A, U64_Value, Pop_Outcome);
         Assert
           (Pop_Outcome = MPMC.Popped and then U64_Value = Round * 2,
            "capacity-two MPMC duplicated or reordered an element");
         MPMC.Try_Pop (Small_B, U64_Value, Pop_Outcome);
         Assert (Pop_Outcome = MPMC.Empty, "capacity-two MPMC did not return to empty");
         if Round = 1 then
            Failed := False;
            begin
      ...
      begin
         Write_U32
           (Base_B,
            Raw_Offset (Scratch_MPMC_Location, 0),
         ...
         Write_U32 (Base_B, Raw_Offset (Scratch_MPMC_Location, 0), Saved_State);
         Assert (Failed, "corrupt lifecycle was reported as healthy");
      end;
      MPMC.Destroy (Small_A);
      MPMC.Detach (Small_B);

      Write_U32 (Base_B, Raw_Offset (Scratch_MPMC_Location, 0), 16#FFFF_FFFA#);
      Failed := False;
      begin
         MPMC.Initialize (Small_A, Region_A, Scratch_MPMC_Location, 2);
      exception
   ...
   declare
      ...
      Failed        : Boolean := False;
   begin
      Maps.Initialize (Scratch, Region_A, Scratch_Map_Location, 2);
      Maps.Attach (Peer, Region_B, Scratch_Map_Location, 2);
      Home := Test_Hash (Key_1) and 1;
      Write_U32 (Base_B, Map_Entry_Offset_At (Scratch_Map_Location, Home, 0), 9);
      begin
      ...
      Maps.Initialize (Scratch, Region_A, Scratch_Map_Location, 2);
      Maps.Put (Scratch, Decode (Key_1), Decode (Value_1), Put_Outcome);
      Write_U64 (Base_B, Raw_Offset (Scratch_Map_Location, 48), 0);
      Failed := False;
      begin
      ...
      Assert (Failed and then Maps.Is_Poisoned (Scratch), "hash-map removal underflow did not fail closed");

      Maps.Initialize (Scratch, Region_A, Scratch_Map_Location, 2);
      Write_U64 (Base_B, Raw_Offset (Scratch_Map_Location, 48), 2);
      Failed := False;
      begin
         Maps.Put (Scratch, Decode (Key_1), Decode (Value_1), Put_Outcome);
      exception
      ...
      Assert (Failed and then Maps.Is_Poisoned (Scratch), "hash-map insertion overflow did not fail closed");
      ...
      Maps.Detach (Peer);
      Maps.Attach (Peer, Region_B, Scratch_Map_Location, 2);
      Vectors.Initialize (Replacement, Region_A, Scratch_Map_Location, 2);
      Failed := False;
      begin
   ...
   Assert (Allocation = Slabs.Allocated and then not Handles.Is_Null (Handle_1), "slab allocation failed");
   ...
   begin
      ...
      Assert (Read_U32 (Base_A, State_At) = 3, "failed slab contender released another owner's claim");
   end;
   Slabs.Detach (Slab_A);
   Slabs.Detach (Slab_B);
   Slabs.Poison_Abandoned_At (Region_B, Slab_Location, 8, Poison_Handle.Slot);
   ...
   for Index in Recovered_Handles'Range loop
      Slabs.Try_Allocate (Slab_A, Payload_16, Recovered_Handles (Index), Allocation);
      Assert (Allocation = Slabs.Allocated, "recovery verification allocation failed");
   ...
   declare
      ...
      for Source'Address use
        SSE."+" (Base_A, SSE.Storage_Offset (DS.Byte_Count (String_Location) + DS.Byte_Count (70)));
   ...
   begin
      ...
      Assert (Result (9 .. 13) = Expected, "overlapping byte-string append did not preserve its source");
      Strings.Assign (String_A, String_Data);
   ...
   Assert (Vectors.Read (Vector_B, 1) = 1, "zero-copy vector A-to-B read failed");
   Vectors.Replace (Vector_B, 1, 2);
   Assert (Vectors.Read (Vector_A, 1) = 2, "vector B-to-A replace failed");
   declare
      Failed : Boolean := False;
   begin
      begin
   ...
   declare
      ...
      Failed          : Boolean;
   begin
      Strings.Initialize (Recovery_String, Region_A, Poison_String_Location, 32);
      Write_U32 (Base_B, Raw_Offset (Poison_String_Location, 44), 2);
      Failed := False;
      begin
      ...
      Write_U32 (Base_B, Raw_Offset (Poison_String_Location, 44), 1);
      Failed := False;
      begin
         if Strings.Length (Recovery_String) /= 0 then
      ...
      Failed := False;
      begin
         Strings.Attach (Recovery_Peer, Region_B, Poison_String_Location, 32);
      exception
         when DS.Poison_Error =>
            Failed := True;
      end;
      ...
      Failed := False;
      begin
         Strings.Create_Or_Attach (Recovery_Peer, Region_B, Poison_String_Location, 32, Open_Outcome);
      exception
         when DS.Poison_Error =>
            Failed := True;
      end;
      ...
      Strings.Initialize (Recovery_String, Region_A, Poison_String_Location, 32);
      Assert (not Strings.Is_Poisoned (Recovery_String), "byte-string reinitialization did not clear poison");
      Strings.Attach (Recovery_Peer, Region_B, Poison_String_Location, 32);
      Strings.Assign (Recovery_String, String_Data);
      Strings.Destroy (Recovery_String);
      Strings.Detach (Recovery_Peer);

      Vectors.Initialize (Recovery_Vector, Region_A, Poison_Vector_Location, 4);
      Write_U32 (Base_B, Raw_Offset (Poison_Vector_Location, 44), 1);
      Failed := False;
      begin
         Vectors.Try_Append (Recovery_Vector, 1, 0.0, Flag);
      exception
         when DS.Timeout_Error =>
            Failed := True;
      end;
      Assert (Failed, "timed vector access ignored an owned guard");
      Write_U32 (Base_B, Raw_Offset (Poison_Vector_Location, 44), 0);
      Vectors.Poison (Region_B, Poison_Vector_Location);
      Assert (Vectors.Is_Poisoned (Recovery_Vector), "vector poison was not visible across mappings");
      Failed := False;
      begin
         Vectors.Try_Append (Recovery_Vector, 1, Flag);
      exception
         when DS.Poison_Error =>
            Failed := True;
      end;
      ...
      Vectors.Initialize (Recovery_Vector, Region_A, Poison_Vector_Location, 4);
      Vectors.Try_Append (Recovery_Vector, 91, Flag);
      Assert (Flag, "reinitialized vector rejected an append");
      Assert
        (Vectors.Read (Recovery_Vector, 1) = 91, "reinitialized vector did not restore normal operation");
   ...
   for Value in Interfaces.Unsigned_64 range 1 .. 16 loop
      SPSC.Try_Pop (Ring_B, U64_Value, Flag);
      Assert (Flag and then U64_Value = Value, "SPSC ordering or exactly-once delivery failed");
   end loop;
   ...
   Assert (Pop_Outcome = MPMC.Popped and then U64_Value = 41, "MPMC cross-view pop failed");
   ...
   Assert (Flag and then U64_Value = 111, "hash-map A-to-B lookup failed");
   ...
   Assert (Flag and then U64_Value = 222, "hash-map B-to-A replacement was not visible");

   declare
      Home       : constant Interfaces.Unsigned_64 := Test_Hash (Key_1) and 15;
      Saved_Hash : constant Interfaces.Unsigned_64 := Read_U64 (Base_B, Map_Entry_Offset (Home, 8));
      Failed     : Boolean := False;
   begin
      Write_U64 (Base_B, Map_Entry_Offset (Home, 8), Saved_Hash xor 1);
      begin
      ...
      Assert (not Maps.Is_Attached (Map_Bad), "failed hash-map attach retained a usable local view");
      Failed := False;
      begin
   ...
   declare
      ...
      Target_State : constant Interfaces.Unsigned_32 := Read_U32 (Base_B, Map_Entry_Offset (Target, 0));
      Target_Hash  : constant Interfaces.Unsigned_64 := Read_U64 (Base_B, Map_Entry_Offset (Target, 8));
      Target_Key   : constant Interfaces.Unsigned_64 := Read_U64 (Base_B, Map_Entry_Offset (Target, 16));
      Target_Value : constant Interfaces.Unsigned_64 := Read_U64 (Base_B, Map_Entry_Offset (Target, 24));
      Home_Key     : constant Interfaces.Unsigned_64 := Read_U64 (Base_B, Map_Entry_Offset (Home, 16));
      Home_Value   : constant Interfaces.Unsigned_64 := Read_U64 (Base_B, Map_Entry_Offset (Home, 24));
      Failed       : Boolean := False;
   begin
      Assert
      ...
      Write_U64 (Base_B, Map_Entry_Offset (Target, 8), Test_Hash (Key_1));
   ...
   Assert (Flag and then Vectors.Read (Wrapped_B, 1) = 909, "versioned envelope content did not relocate");
   declare
      Wrong  : Contract_V2.View;
      Failed : Boolean := False;
   begin
      begin
         Contract_V2.Attach (Wrong, Region_B, Envelope_Location, Envelope_Content_Extent, 8);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
   ...
   begin
      begin
         Contract_Other.Attach (Wrong, Region_B, Envelope_Location, Envelope_Content_Extent, 8);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
   ...
   begin
      begin
         Contract_Wrong_Leaf.Attach (Wrong, Region_B, Envelope_Location, Envelope_Content_Extent, 8);
      exception
         when DS.Layout_Error =>
            Failed := True;
      end;
   ...
   declare
      ...
      Failed                                         : Boolean := False;
   begin
      Contract_V1.Initialize (First_Envelope, Region_A, Crash_Envelope_Location, Envelope_Content_Extent, 8);
      Crash_Content := Contract_V1.Content_Location (First_Envelope);
      Vectors.Initialize (Stale_Leaf, Region_A, Crash_Content, 4);
      Vectors.Try_Append (Stale_Leaf, 707, Flag);
      Assert
        (Flag and then (Read_U32 (Base_B, Raw_Offset (Crash_Content, 0)) and 7) = 2,
         "stale nested leaf was not ready before envelope reuse");
      Vectors.Detach (Stale_Leaf);
      Contract_V1.Detach (First_Envelope);

      Contract_V1.Initialize (Reused_Envelope, Region_A, Crash_Envelope_Location, Envelope_Content_Extent, 8);
      Contract_V1.Attach (Peer_Envelope, Region_B, Crash_Envelope_Location, Envelope_Content_Extent, 8);
      Assert
      ...
      Assert (Failed, "stale nested leaf survived the envelope initialization window");

      Vectors.Initialize (New_Leaf, Region_A, Crash_Content, 4);
      Vectors.Attach (Peer_Leaf, Region_B, Crash_Content, 4);
      Assert
        (Vectors.Length (Peer_Leaf) = 0, "nested leaf did not finish initialization after envelope reuse");
   ...
   declare
      Saved  : constant Interfaces.Unsigned_64 := Read_U64 (Base_B, Raw_Offset (Slab_Location, 8));
      Failed : Boolean := False;
   begin
   ...
   declare
      Saved  : constant Interfaces.Unsigned_32 := Read_U32 (Base_B, Raw_Offset (Slab_Location, 0));
      Failed : Boolean := False;
   begin
   ...
   Regions.Attach (Truncated, Base_B, DS.Byte_Count (Slab_Location) + DS.Byte_Count (64));
   declare
      Failed : Boolean := False;
   begin
      begin
   ...
   declare
      Saved  : constant Interfaces.Unsigned_64 := Read_U64 (Base_B, Raw_Offset (SPSC_Location, 128));
      Failed : Boolean := False;
   begin
      ...
      Assert (not SPSC.Is_Attached (Ring_Bad), "failed SPSC attach retained a usable local view");
   end;

   declare
      Saved  : constant Interfaces.Unsigned_64 := Read_U64 (Base_B, Raw_Offset (MPMC_Location, 192));
      Failed : Boolean := False;
   begin
      ...
      Assert (Failed, "quiescent MPMC destruction accepted a corrupt slot sequence");
      Assert (MPMC.Is_Attached (Multi_Bad), "failed MPMC destruction detached its diagnostic view");
   ...
   Assert (Unmap_And_Reserve (Base_A, Mapping_Length) = 0, "failed to reserve the old mapping range");
   Assert (Remap (FD, Mapping_Length, Base_C'Access) = 0, "failed to map the backing file a third time");
   Assert (Base_C /= Base_A and then Base_C /= Base_B, "third mapping reused an existing virtual base");
   ...
   Arenas.Attach
     (Arena_C,
      ...
      16#A8E4_7B19_2C63_D501#);
   Best_Fit_Arenas.Attach
     (Best_Fit_C, Region_C, Best_Fit_Arena_Location, Best_Fit_Configuration, Best_Fit_Instance);
   Best_Fit_Dynamic_Vectors.Attach (Best_Fit_Vector_C, Region_C, Best_Fit_Dynamic_Location, Best_Fit_C, 2);
   TLSF_Arenas.Attach (TLSF_C, Region_C, TLSF_Arena_Location, TLSF_Configuration, TLSF_Instance);
   TLSF_Dynamic_Vectors.Attach (TLSF_Vector_C, Region_C, TLSF_Dynamic_Location, TLSF_C, 2);
   Adaptive_U64.Attach (Adaptive_C, Region_C, Adaptive_Pool_Location, TLSF_C);
   Dynamic_Vectors.Attach (Dynamic_Vector_C, Region_C, Dynamic_Vector_Location, Arena_C, 2);
   Dynamic_Strings.Attach (Dynamic_String_C, Region_C, Dynamic_String_Location, Arena_C, 4);
   Dynamic_Maps.Attach (Dynamic_Map_C, Region_C, Dynamic_Map_Location, Arena_C, 2);
   ...
   Contract_V1.Attach (Envelope_C, Region_C, Envelope_Location, Envelope_Content_Extent, 8);
   Vectors.Attach (Wrapped_C, Region_C, Contract_V1.Content_Location (Envelope_C), 4);

   Assert
     (Contains_U64 (Base_C, Mapping_Length, Interfaces.Unsigned_64 (SSE.To_Integer (Base_C))) = 0,
   ...
   Assert (Read_16 = Payload_16, "arena mutation was not visible after the third mapping");
   Arenas.Release (Arena_B, Arena_Handle);
   Best_Fit_Arenas.Read (Best_Fit_C, Best_Fit_Handle, 0, Read_16);
   Assert (Read_16 = Arena_Data, "best-fit arena did not survive the third mapping");
   Best_Fit_Arenas.Write (Best_Fit_C, Best_Fit_Handle, 16, Payload_16);
   Best_Fit_Arenas.Read (Best_Fit_B, Best_Fit_Handle, 16, Read_16);
   Assert (Read_16 = Payload_16, "best-fit mutation was not visible after the third mapping");
   Best_Fit_Arenas.Release (Best_Fit_B, Best_Fit_Handle);
   Best_Fit_Dynamic_Vectors.Try_Append (Best_Fit_Vector_C, Best_Fit_C, 41, Growth);
   Assert
     (Growth = DS.Dynamic.Completed
      and then Best_Fit_Dynamic_Vectors.Read (Best_Fit_Vector_B, Best_Fit_B, 41) = 41,
      "best-fit dynamic vector did not continue after remapping");
   TLSF_Arenas.Read (TLSF_C, TLSF_Handle, 0, Read_16);
   Assert (Read_16 = Arena_Data, "TLSF arena did not survive the third mapping");
   TLSF_Arenas.Write (TLSF_C, TLSF_Handle, 16, Payload_16);
   TLSF_Arenas.Read (TLSF_B, TLSF_Handle, 16, Read_16);
   Assert (Read_16 = Payload_16, "TLSF mutation was not visible after the third mapping");
   TLSF_Arenas.Release (TLSF_B, TLSF_Handle);
   TLSF_Dynamic_Vectors.Try_Append (TLSF_Vector_C, TLSF_C, 41, Growth);
   Assert
     (Growth = DS.Dynamic.Completed and then TLSF_Dynamic_Vectors.Read (TLSF_Vector_B, TLSF_B, 41) = 41,
      "TLSF dynamic vector did not continue after remapping");
   declare
      New_Handle : Adaptive_U64.Handle;
      Result     : Adaptive_U64.Allocation_Result;
   begin
      Adaptive_U64.Try_Allocate (Adaptive_C, TLSF_C, 101, New_Handle, Result);
      Assert
      ...
      Assert (U64_Value = 101, "adaptive-pool allocation was not visible across mappings");
      Adaptive_U64.Release (Adaptive_B, TLSF_B, New_Handle);
   end;
   for Index in 2 .. Adaptive_Handles'Last loop
      Adaptive_U64.Release (Adaptive_C, TLSF_C, Adaptive_Handles (Index));
   end loop;
   Dynamic_Vectors.Try_Append (Dynamic_Vector_C, Arena_C, 21, Growth);
   ...
   Dynamic_Strings.Try_Assign (Dynamic_String_C, Arena_C, String_More, Growth);
   declare
   ...
   Dynamic_Maps.Put (Dynamic_Map_C, Arena_C, 21, 210, Dynamic_Put);
   Dynamic_Maps.Get (Dynamic_Map_B, Arena_B, 21, U64_Value, Flag);
   Assert
     (Dynamic_Put = Dynamic_Maps.Put_Inserted and then Flag and then U64_Value = 210,
      "dynamic map did not continue after the third mapping");
   Dynamic_Maps.Remove (Dynamic_Map_B, Arena_B, 1, Flag);
   Assert
   ...
   begin
      ...
      Assert (Remapped_Read = String_More, "byte string mutation was not visible after third mapping");
   end;
   Strings.Append (String_B, String_Data);
   Strings.Read (String_C, String_Read);
   Assert
     (String_Read (1 .. 5) = String_More and then String_Read (6 .. 8) = String_Data,
      "byte string did not continue across the third mapping");

   Vectors.Try_Append (Vector_C, 3, Flag);
   Assert (Flag and then Vectors.Length (Vector_B) = 2, "vector did not continue after remap");
   SPSC.Try_Push (Ring_C, 77, Flag);
   SPSC.Try_Pop (Ring_B, U64_Value, Flag);
   Assert (Flag and then U64_Value = 77, "SPSC did not continue after remap");
   MPMC.Try_Push (Multi_C, 88, Push_Outcome);
   MPMC.Try_Pop (Multi_B, U64_Value, Pop_Outcome);
   Assert
     (Push_Outcome = MPMC.Pushed and then Pop_Outcome = MPMC.Popped and then U64_Value = 88,
   ...
   SPSC.Try_Pop (Ring_B, U64_Value, Flag);
   Assert (Flag and then U64_Value = 90, "SPSC did not recover through exclusive reinitialization");
   ...
   MPMC.Try_Pop (Multi_B, U64_Value, Pop_Outcome);
   Assert
     (Push_Outcome = MPMC.Pushed and then Pop_Outcome = MPMC.Popped and then U64_Value = 92,
   ...
   Assert (Put_Outcome = Maps.Inserted and then Flag, "hash map did not continue after remap");
   Maps.Remove (Map_C, Decode (Key_1), Flag);
   Assert (Flag and then Maps.Length (Map_B) = 1, "hash-map removal failed across mappings");
   ...
   Write_U32 (Base_C, C.size_t (Map_Location) + C.size_t'(64), Interfaces.Unsigned_32'(1));
   declare
      Failed : Boolean := False;
   begin
      begin
      ...
      Failed := False;
      begin
         Maps.Put (Map_C, Decode (Key_1), Decode (Value_1), 0.0, Put_Outcome);
      exception
         when DS.Timeout_Error =>
            Failed := True;
      end;
   ...
   Assert (Vectors.Read (Wrapped_C, 1) = 909, "versioned envelope did not survive third mapping");
   ...
   Assert (Unmap (Base_A, Mapping_Length) = 0, "failed to release reserved old range");
   Base_A := System.Null_Address;
   Assert (Close_Mapping (Path, FD) = 0, "failed to close temporary mapping");
   FD := -1;
