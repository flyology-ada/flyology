...
procedure Socket_Handoff_Smoke is
   ...
   function Send_Descriptor_Once
     (Carrier, Descriptor : Interfaces.C.int) return Interfaces.C.long;
   pragma Import
     (C, Send_Descriptor_Once, "flyology_shm_send_fd_once");
   ...
   procedure Open_Channel_Pair
     (Left  : in out Handoffs.Handoff_Channel;
      Right : in out Handoffs.Handoff_Channel)
   is
   ...
   begin
      ...
      Sockets.Accept_Connection
        (Received, Accepted, Peer, Timeout => 1.0);
