...
begin
   ...
   pragma Assert (Classify_Post_Accept_Failure (Peer_Address_Decode) = Fail_Listener);
   pragma Assert (Classify_Post_Accept_Failure (Descriptor_Configuration) = Discard_Accepted_Peer);
   ...
   pragma Assert (Classify_Connect_Error (Interrupted) = Wait_For_Connection);
   pragma Assert (Classify_Connect_Error (In_Progress) = Wait_For_Connection);
   pragma Assert (Classify_Connect_Error (Already_In_Progress) = Wait_For_Connection);
