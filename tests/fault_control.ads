...
private
   ...
   function C_Calls (At_Point : Interfaces.C.int) return Interfaces.C.unsigned;
   ...
   pragma
     Import
       (C,
        C_Descriptor_Cancel_Timer_Parked,
        "flyology_test_descriptor_cancel_timer_parked");
   ...
   pragma
     Import
       (C,
        ...
        "flyology_test_release_descriptor_cancel_timer");
