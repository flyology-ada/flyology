...
package Flyology.Shared_Memory.Testing is
   ...
   procedure Store_Release_U32 (Item : Mapping; Offset : Byte_Length; Value : Interfaces.Unsigned_32);
   procedure Store_Release_U64 (Item : Mapping; Offset : Byte_Length; Value : Interfaces.Unsigned_64);
