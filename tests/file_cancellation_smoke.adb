...
procedure File_Cancellation_Smoke is
   ...
   begin
      ...
      if not Event_Done then
         raise Program_Error with "zero-length lightweight file operation failed";
      end if;
   ...
   procedure Test_Completion_Races (Kind : Flyology.Execution_Model) is
...
begin
   ...
   Test_Completion_Races (Flyology.Native_Task);
   Test_Completion_Races (Flyology.Lightweight_Task);
