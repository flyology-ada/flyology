package body System.Flyology.Faults is
   ...
   procedure Test_Begin_Descriptor_Cancel_Timer;
   pragma Import (C, Test_Begin_Descriptor_Cancel_Timer, "flyology_test_begin_descriptor_cancel_timer");

   function Test_Descriptor_Cancel_Timer_Released return Interfaces.C.int;
   pragma Import (C, Test_Descriptor_Cancel_Timer_Released, "flyology_test_descriptor_cancel_timer_released");
   ...
   procedure Pause_Descriptor_Cancel_Timer is
      Ignored : Interfaces.C.int;
      pragma Unreferenced (Ignored);
   begin
      Test_Begin_Descriptor_Cancel_Timer;
      while Test_Descriptor_Cancel_Timer_Released = 0 loop
         Ignored := Usleep (1_000);
      end loop;
   end Pause_Descriptor_Cancel_Timer;
