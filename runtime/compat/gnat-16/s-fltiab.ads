...
is
   ...
   function To_Duration (Value : Timespec) return Duration renames System.C_Time.To_Duration;

   function To_Timespec (Value : Duration) return Timespec renames System.C_Time.To_Timespec;
