...
package System.Flyology.File_Engine is
   ...
   type Event_Completion_Disposition is (Completion_Produced, Completion_Ignored, Completion_Failed);

   function Initialize
     (Item : in out Engine; Poller_FD : Interfaces.C.int; Wake_FD : Interfaces.C.int) return Boolean;
   ...
   function Cancel
     (Item           : in out Engine;
      ...
      Error_Code     : out Interfaces.C.int) return Cancellation_Disposition;
   ...
   function Drain (Item : in out Engine; Values : out Completion_Array; Count : out Natural) return Boolean
