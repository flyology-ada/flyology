...
package System.Flyology.Task_Results is
   ...
   procedure Attach_Task_Result (T : System.Tasking.Task_Id; Storage : System.Address);
   ...
   function Detach_Task_Result (T : System.Tasking.Task_Id) return System.Address;
   ...
   function Observe_Task
     (T : System.Address; Item : System.Address; Item_Size : Interfaces.C.size_t) return Interfaces.C.int;
   pragma Export (C, Observe_Task, "flyology_runtime_task_result_observe_task");
   ...
   function Wait_Task
     (T : System.Address; Timeout_Nanoseconds : Interfaces.C.long_long) return Interfaces.C.int;
   pragma Export (C, Wait_Task, "flyology_runtime_task_result_wait_task");
   ...
   pragma Export (C, Attach_Monitor, "flyology_runtime_task_result_monitor_attach");
   ...
   pragma Export (C, Retain_Monitor, "flyology_runtime_task_result_monitor_retain");
   ...
   pragma Export (C, Release_Monitor, "flyology_runtime_task_result_monitor_release");
   ...
   function Observe_Monitor
     (Storage : System.Address; Item : System.Address; Item_Size : Interfaces.C.size_t)
      return Interfaces.C.int;
   pragma Export (C, Observe_Monitor, "flyology_runtime_task_result_monitor_observe");
   ...
   function Wait_Monitor
     (Storage : System.Address; Timeout_Nanoseconds : Interfaces.C.long_long) return Interfaces.C.int;
   pragma Export (C, Wait_Monitor, "flyology_runtime_task_result_monitor_wait");
   ...
   pragma Export (C, Subscribe_Monitor, "flyology_runtime_task_result_monitor_subscribe");
   ...
   function Unsubscribe_Monitor
     (Storage : System.Address; Subscription_Node : System.Address; Node_Size : Interfaces.C.size_t)
      return Interfaces.C.int;
   pragma Export (C, Unsubscribe_Monitor, "flyology_runtime_task_result_monitor_unsubscribe");
