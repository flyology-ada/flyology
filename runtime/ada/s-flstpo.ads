...
is
   ...
   function Mappable (Usable_Size, Guard_Size : Byte_Count) return Boolean
   is (Usable_Size /= 0
   ...
   function Maximum_Request (Page_Size, Guard_Size : Byte_Count) return Byte_Count
   ...
   function Accepts (Request, Page_Size, Guard_Size : Byte_Count) return Boolean
   is (Request /= 0 and then Request <= Maximum_Request (Page_Size, Guard_Size));
   ...
   --  project runs.
   function Usable_Bytes (Request, Page_Size, Guard_Size : Byte_Count) return Byte_Count
   with
     Post =>
       (if Accepts (Request, Page_Size, Guard_Size)
        then
          Usable_Bytes'Result >= Request
