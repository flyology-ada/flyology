...
package System.Flyology.Contexts is
   ...
   function Advise_Stack_Cold (Item : not null Context_Access) return Interfaces.C.int;
   ...
   function Advise_Stack_Pageout (Item : not null Context_Access) return Interfaces.C.int;
   ...
   function Observe_Stack_Pool
     (Snapshot : System.Address; Snapshot_Size : Interfaces.C.size_t) return Interfaces.C.int;
   pragma Export (C, Observe_Stack_Pool, "flyology_runtime_observe_stack_pool");
...
private
   ...
   type Register_Array is array (Natural range 0 .. 21) of Interfaces.C.unsigned_long;
