...
test -f "$site_output/guide/stacks/index.html"
test -f "$site_output/guide/task-memory/index.html"
test -f "$site_output/guide/execution-groups/index.html"
test -f "$site_output/guide/task-aware-io/index.html"
test -f "$site_output/guide/scoped-operations/index.html"
test -f "$site_output/guide/resource-budgets/index.html"
test -f "$site_output/guide/observability/index.html"
test -f "$site_output/guide/verification/index.html"
test -f "$site_output/guide/constraints/index.html"
...
test -f "$site_output/guide/cli/index.html"
...
test -f "$site_output/ci/index.html"
test -f "$site_output/assets/scripts/ci.mjs"
test -f "$site_output/assets/styles/ci.css"
...
node "$project_root/scripts/test-ci-page.mjs"
node "$project_root/scripts/check-guide-index.mjs"
